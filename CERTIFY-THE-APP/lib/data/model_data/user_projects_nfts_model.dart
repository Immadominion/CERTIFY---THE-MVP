...
class UserProjectsNftsModel {
    ...
    UserProjectsNftsModel copyWith({
        int? id,
        String? status,
        String? mintAddress,
        bool? semifungible,
    ...
    factory UserProjectsNftsModel.fromJson(String str) => UserProjectsNftsModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory UserProjectsNftsModel.fromMap(Map<String, dynamic> json) => UserProjectsNftsModel(
        id: json["id"],
        status: json["status"],
